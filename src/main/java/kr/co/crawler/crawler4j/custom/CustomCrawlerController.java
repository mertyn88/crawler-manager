package kr.co.crawler.crawler4j.custom;
...
public class CustomCrawlerController {
    ...
    static final Logger logger = LoggerFactory.getLogger(CustomCrawlerController.class);
    ...
    public CustomCrawlerController(CrawlConfig config, PageFetcher pageFetcher,
                           RobotstxtServer robotstxtServer) throws Exception {
        this(config, pageFetcher, new Parser(config), robotstxtServer);
    }

    public CustomCrawlerController(CrawlConfig config, PageFetcher pageFetcher, Parser parser,
                           RobotstxtServer robotstxtServer) throws Exception {
        config.validate();
        this.config = config;
    ...
    public interface CustomCrawlerFactory<T extends CustomCrawler> {
        T newInstance() throws Exception;
    }

    private static class DefaultCustomCrawlerFactory<T extends CustomCrawler>
            implements CustomCrawlerController.CustomCrawlerFactory<T> {
        final Class<T> clazz;

        DefaultCustomCrawlerFactory(Class<T> clazz) {
            this.clazz = clazz;
        }
     ...
     * @param <T> Your class extending CustomCrawler
     */
    public <T extends CustomCrawler> void start(Class<T> clazz, int numberOfCrawlers) {
        this.start(new CustomCrawlerController.DefaultCustomCrawlerFactory<>(clazz), numberOfCrawlers, true);
    }
     ...
     * @param <T> Your class extending CustomCrawler
     */
    public <T extends CustomCrawler> void start(CustomCrawlerController.CustomCrawlerFactory<T> crawlerFactory,
     ...
     * @param <T> Your class extending CustomCrawler
     */
    public <T extends CustomCrawler> void startNonBlocking(CustomCrawlerController.CustomCrawlerFactory<T> crawlerFactory,
     ...
     * @param <T> Your class extending CustomCrawler
     */
    public <T extends CustomCrawler> void startNonBlocking(Class<T> clazz, int numberOfCrawlers) {
        start(new CustomCrawlerController.DefaultCustomCrawlerFactory<>(clazz), numberOfCrawlers, false);
    }

    protected <T extends CustomCrawler> void start(final CustomCrawlerController.CustomCrawlerFactory<T> crawlerFactory,
        ...
        try {
            ...
            final CustomCrawlerController controller = this;
    ...
    /**
     * @deprecated implements a factory {@link CustomCrawlerController.CustomCrawlerFactory} and inject your cutom data as
