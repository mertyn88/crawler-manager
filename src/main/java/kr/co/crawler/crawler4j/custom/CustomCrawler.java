 ...
 */
public class CustomCrawler implements Runnable {

    protected static final Logger logger = LoggerFactory.getLogger(CustomCrawler.class);
     ...
     */
    protected CustomCrawlerController myController;
     ...
     */
    public void init(int id, CustomCrawlerController crawlController)
    ...
    public CustomCrawlerController getMyController() {
        return myController;
    }
            ...
            if (statusCode < 200 ||
                ...
                if (shouldFollowLinksIn(page.getWebURL())) {
                    ...
                    for (WebURL webURL : parseData.getOutgoingUrls()) {
                        ...
                        //webURL.setParentUrl(curURL.getURL()); // 여기서 변경해야할것같다.
                        //이준명
